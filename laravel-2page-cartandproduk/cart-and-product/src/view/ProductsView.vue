<template>
  ...
  <Products :data="availableProducts" @addItem="addOneItem" @addAll="addAllItem" @showAddProductForm="showAddProductForm" />
  <div class="mt-5">
    <RouterLink to="/cart">
      <Button color="btn-outline-primary" content="CART" />
    </RouterLink>
  </div>
</template>
